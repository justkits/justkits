...
const colors = convertToLightDark(justkitsLight, justkitsDark);
...
const text: TextTokens = {
  ...
  codeLarge: `${typography.fontWeight.regular} ${typography.fontSize.bodyLarge}/${typography.lineHeight.bodyLarge} ${typography.fontFamily.code}`,
...
export const justkitsDefault = buildCssVariables({
  colors,
  text,
  typography,
});
